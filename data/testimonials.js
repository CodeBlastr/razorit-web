...
export const testimonials5 = [
  {
    text: "The biggest project our company has ever completed. Requirements gathering, analysis, design, training, support and more. 🙏",
    author: "Jack Haines",
    position: "Founder @ HealthcareIntegrations",
    imgSrc: "/assets/images/clients/jack-haines.png",
    altText: "Jack Haines Client Portrait",
    extraClass: "mt-50 mt-sm-0",
  },
  {
    text: "Outstanding attention to detail every step of the way. Trusted, Available, and Highly Communicative.",
    author: "Brian Fields",
    position: "Director @ InformedDNA",
    imgSrc: "/assets/images/clients/brian-fields.png",
    altText: "Brian Fields Client Portrait",
    extraClass: "",
  },
  {
    ...
    altText: "Charles Wismer Client Portrait",
    extraClass: "",
  },
  {
    text: "Contagious enthusiasm. Strong ability to manage all aspects of organization in a way that delivers results quickly. It's truly a refreshing pleasure to work with someone who possesses this level of professionalism.",
    author: "David Almodovar",
    position: "Managing Partner @ Aᴳ",
    imgSrc: "/assets/images/clients/david-almodovar.png",
    altText: "David Almodovar Client Portrait",
    extraClass: "",
  },
];
